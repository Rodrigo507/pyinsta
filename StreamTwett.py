...
def uploadVideo(bot,txt):
    # parametros
    # bot: bot logeado de instagram
    # txt: Mensaje del post
    bot.upload_video('multimedia/videos/video.mp4', caption=txt)
    time.sleep(5)
...
class MyStreamListener(tweepy.StreamListener):
    # Funcion de login on acoutn
    # def on_connect(self):
    #     print("Stoy Conectado")
                ...
                try:
                    if 'extended_entities' in status.extended_tweet:  # si existe las extended_entities para fotos o videos (multimedia)
                        ...
                        if tipoMultimediaExtended_tweet == 'photo':  # fotos
                            ...
                            video = 1
                            urlDown = \
                            status.extended_tweet['extended_entities']['media'][0]['video_info']['variants'][0]['url']
